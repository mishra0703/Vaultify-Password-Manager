     ...
     <div className="main-content flex flex-col items-center mt-[8vh] mb-10 gap-5">
        ...
        <div className="passwordList w-full mx-auto my-8">
          {passwordArray.length === 0 && (
            <div className="font-bold text-3xl flex justify-center mt-5 opacity-50">No Passwords To Show</div>
          )}
          {passwordArray.length != 0 && (
            <DataTable passwordArray={passwordArray} setPasswordArray = {setPasswordArray} formData={formData} setFormData = {setFormData}/>
          )}
        </div>
      </div>
    </>
